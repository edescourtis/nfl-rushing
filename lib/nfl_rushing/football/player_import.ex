defmodule NflRushing.Football.PlayerImport do
  ...
  def load_ndjson!(filename) do
    ...
    |> Stream.each(fn football_player_jsons ->
      datetime = NaiveDateTime.utc_now() |> NaiveDateTime.truncate(:second)

      players =
        for football_player_json <- football_player_jsons do
  ...
  defp json_to_schema_player(%{
    ...
    {longest_rush, longest_rush_touchdown} =
      case Integer.parse("#{longest_rush_with_maybe_touchdown}") do
